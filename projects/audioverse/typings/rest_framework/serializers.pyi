...
class BaseSerializer(Field):
    ...
    @property
    def errors(self): # -> ReturnList | list[ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, Any] | ErrorDetail] | ErrorDetail] | ErrorDetail] | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, Any] | ErrorDetail] | ErrorDetail] | ErrorDetail:
        ...
...
def as_serializer_error(exc): # -> dict[str | Any, list[ErrorDetail] | ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, Any] | ErrorDetail] | list[Any] | Mapping[Any, Any] | list[ErrorDetail | Any]] | dict[Any | list[Any] | None, list[ErrorDetail] | ReturnList | list[ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, ReturnList | ReturnDict | dict[Any, Any] | ErrorDetail] | ErrorDetail] | ErrorDetail]] | dict[Any | list[Any] | None, list[ErrorDetail]]:
    ...
